package net.bncloud.msk3cloud.util;
...
/**
 * {@link net.bncloud.msk3cloud.core.fieldparse.FieldKey 注解的工具}
 * @author Rao
 * @Date 2022/01/12
 **/
public class FieldKeyAnoUtils {
    ...
    private static Map<String, String> parseClassField(Class<?> cls){
        FieldKey clsFieldKey = cls.getDeclaredAnnotation( FieldKey.class );
    ...
    public static List<String> getFieldKeyList(Class<?> cls){
        Map<String, String> fieldKeyFieldNameMap = parseClassField(cls);
