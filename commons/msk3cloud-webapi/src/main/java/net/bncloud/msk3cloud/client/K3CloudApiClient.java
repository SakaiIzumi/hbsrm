...
import net.bncloud.msk3cloud.constant.K3CloudApiConstants;
import net.bncloud.msk3cloud.kingdee.entity.common.EntityResult;
import net.bncloud.msk3cloud.kingdee.entity.login.ValidateUser;
...
public class K3CloudApiClient implements ApiClient {
    ...
    public K3CloudApiClient( K3CloudApiConfig k3CloudApiConfig ) {
        ...
        // info
        Objects.requireNonNull( k3CloudApiConfig,"config not null!");
        this.k3CloudApiConfig = k3CloudApiConfig;

        // init
        IdentifyInfo identifyInfo = new IdentifyInfo();
        identifyInfo.setdCID( k3CloudApiConfig.getAcctId() );
        identifyInfo.setAppId( k3CloudApiConfig.getAppId() );
        identifyInfo.setAppSecret( k3CloudApiConfig.getAppSecret() );
        identifyInfo.setServerUrl( k3CloudApiConfig.getServerUrl());
        identifyInfo.setUserName( k3CloudApiConfig.getUserName() );
        identifyInfo.setPwd( k3CloudApiConfig.getPassword());
        identifyInfo.setlCID( k3CloudApiConfig.getLcId() );
    ...
    public <T> ResponseResult<T> queryGroupInfo(GroupQueryParam groupQueryParam) throws Exception {
        String resultString = this.apiInstance().queryGroupInfo(groupQueryParam.toJson());
        return JSONObject.parseObject(resultString,ResponseResult.class);
    }
