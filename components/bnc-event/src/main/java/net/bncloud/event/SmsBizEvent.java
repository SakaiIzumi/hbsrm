...
public abstract class SmsBizEvent<T extends Serializable> extends AbstractBncEvent<T>  {
     ...
     * @param data 业务数据
     */
    public SmsBizEvent(Object source, String eventCode, LoginInfo loginInfo, T data) {
     ...
     * @param sourcesName
     */
    public SmsBizEvent(Object source, String eventCode, LoginInfo loginInfo, T data, String sources, String sourcesName) {
        super(source, eventCode, loginInfo, data);
