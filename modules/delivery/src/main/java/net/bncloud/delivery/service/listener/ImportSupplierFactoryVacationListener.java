...
@Slf4j
@Data
public class ImportSupplierFactoryVacationListener extends AnalysisEventListener<ImportSupplierFactoryVacationVo> {


    private final List<ImportSupplierFactoryVacationVo> returnList = Lists.newArrayList();
    ...
    public void invokeHeadMap(Map<Integer, String> headMap, AnalysisContext context) {
        ...
        if (!(headMap.containsKey(0) && headMap.containsKey(1) && headMap.containsKey(2) && headMap.containsKey(3) &&headMap.containsKey(4) && "发运工厂编码".equals(headMap.get(0))
                && "发运工厂名称".equals(headMap.get(1)) && "日期".equals(headMap.get(2)) && "假期类型".equals(headMap.get(3)) && "备注".equals(headMap.get(4)))) {
    ...
    @Override
    public void invoke(ImportSupplierFactoryVacationVo importFactoryVacationVo, AnalysisContext analysisContext) {
