...
@EnableScheduling
@MapperScan(basePackages = "net.bncloud.financial.mapper")
@ComponentScan({"net.bncloud.common.bizutil.number","net.bncloud.financial"})
public class FinancialApplication {
    ...
    public FinancialApplication(Environment environment) {
