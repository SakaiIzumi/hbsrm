...
@Component("purchaserChangeWorkbenchStrategy")
@AllArgsConstructor
public class PurchaserChangeWorkbenchStrategy implements IChangeWorkbenchStrategy {
    ...
    public void changeWorkbench() {
        ...
        loginInfo.setCurrentMenuNav(MenuNavType.purchaser.name());
        userInfo.getCurrentInfo().setCurrentMenuNavType(MenuNavType.purchaser.name());
