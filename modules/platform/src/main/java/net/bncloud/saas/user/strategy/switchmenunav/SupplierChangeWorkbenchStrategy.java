...
@Component("supplierChangeWorkbenchStrategy")
@AllArgsConstructor
public class SupplierChangeWorkbenchStrategy implements IChangeWorkbenchStrategy {
    ...
    public void changeWorkbench() {
        ...
        loginInfo.setCurrentMenuNav(MenuNavType.supplier.name());
        userInfo.getCurrentInfo().setCurrentMenuNavType(MenuNavType.supplier.name());
